...
* all_activ, listing the activity code associated with each data record (10,299 rows x 1 column)
...
The activity data, subject ID, and selected feature data were then combined into a single dataset of 10,299 rows x 68 columns. The first two columns are labeled “Activity” and “Subject_ID.” The remaining column labels are the 66 features containing either “mean()” or “std()” in their names.
...
These are the features extracted for Step 2 of the assignment. As noted in Section 6, variables with the prefix “t” are in the time domain, and those with the prefix “f” are in the frequency domain. Suffixes “-X,” “-Y,” and “-Z” represent spatial axes. See Section 6 for definitions of derived-value suffixes such as “-max()” and “-min().”
...
This is the complete list of variables captured or derived as described in Section 6 above. As noted there, variables with the prefix “t” are in the time domain, and those with the prefix “f” are in the frequency domain. Suffixes “-X,” “-Y,” and “-Z” represent spatial axes. See Section 6 for definitions of derived-value suffixes such as “-max()” and “-min().”
